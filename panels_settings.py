"""Settings panel for Passbolt Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__passbolt_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=passbolt_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_passbolt"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Passbolt Settings & Accounts", level=2),
